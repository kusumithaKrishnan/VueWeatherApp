...
export default {
  ...
  methods: {
    updateWeather : async function (place){
      try{
       ...
       const { name, sys : { country }, coord: {lat,lon}, main: {temp, temp_min, temp_max, feels_like, humidity}} = weatherData 
        this.weather = {...this.weather, cityName: name, country:country, temperature: temp, lowTemp: temp_min, highTemp: temp_max,
        feelsLike: feels_like, humidity: humidity, longitude: lon, latitude: lat}
        this.citySearch = "";
  ...
  //check weather animations
    ...
    getWeather: async function () {     
      ...
      localStorage.setItem("cityName", this.citySearch)
      // if(this.citySearch === ""){
      //   this.citySearch = localStorage.getItem("cityName")
      // }
      //fetch weather
      try {
        ///check for time of day
      const weatherDetails = await this.updateWeather(this.citySearch)
